...
export class DzikirPetang extends React.Component {
  state = {
    Data: [
      {
        id: 1,
        ...
        <ScrollView style={{flex: 1}}>
          {this.state.Data.map((value, key) => {
            ...
            if (valueKey % 2 == 0) {
              return (
                <View style={styles.boxContent} key={key}>
                  <View style={styles.boxLafaldz}>
                    <Text style={styles.boxLafaldz}>{value.lafaldz}</Text>
                  </View>
                  <View style={styles.boxLafaldz}>
                    <Text style={styles.boxLafaldz}>{value.terjemahan}</Text>
                  </View>
                </View>
              );
              ...
              return (
                <View
                  style={{...styles.boxContent, backgroundColor: 'green'}}
                  key={key}>
                  <View style={styles.boxLafaldz}>
